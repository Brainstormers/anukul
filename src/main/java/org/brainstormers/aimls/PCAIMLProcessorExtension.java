...
public class PCAIMLProcessorExtension implements AIMLProcessorExtension {
	...
	public Set<String> extensionTagNames = MisUtils.stringSet("contactid", "multipleids", "displayname", "dialnumber",
			"emailaddress", "contactbirthday", "addinfo");
	...
	private String newContact(Node node, ParseState ps) {
		...
		log.info("Adding new contact " + displayName + " " + phoneType + " " + dialNumber + " " + emailType + " "
