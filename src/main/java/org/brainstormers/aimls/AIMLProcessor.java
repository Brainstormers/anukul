...
import org.brainstormers.chats.History;
import org.brainstormers.collections.AIMLMap;
import org.brainstormers.utils.CalendarUtils;
import org.brainstormers.utils.DomUtils;
import org.brainstormers.utils.IOUtils;
import org.brainstormers.utils.Interval;
import org.brainstormers.utils.JapaneseTokenizer;
...
public class AIMLProcessor {
 ...
 public static String respond(String input, String that, String topic, Chat chatSession, int srCnt) {
    ...
    private static String sraix(Node node, ParseState ps) {
        HashSet<String> attributeNames = MisUtils.stringSet("botid", "host");
    ...
    private static String map(Node node, ParseState ps) {
        ...
        HashSet<String> attributeNames = MisUtils.stringSet("name");
    ...
    private static String set(Node node, ParseState ps) {                    // add pronoun check
        HashSet<String> attributeNames = MisUtils.stringSet("name", "var");
    ...
    private static String interval(Node node, ParseState ps)  {
        MisUtils.stringSet("style","jformat","from","to");
    ...
    private static String system(Node node, ParseState ps) {
        HashSet<String> attributeNames = MisUtils.stringSet("timeout");
    ...
    private static String condition(Node node, ParseState ps) {
        ...
        HashSet<String> attributeNames = MisUtils.stringSet("name", "var", "value");
